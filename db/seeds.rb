...
users = User.create([
    ...
    {second_name: 'Admin', first_name: 'Admin', email: 'admin@yandex.ru', password: '123456', type: 'Admin'},
])
...
transits = Transit.create([
    ...
    weight: 10, length: 100, width: 110, height: 100, point_of_departure: 'Нижний Новгород',
    destination: 'Москва', distance: nil, price: nil, user_id: users[0].id},
    {second_name: 'Client3', first_name: 'Client3', patronymic: 'Client3', tel: "988333", email: "9883333@yandex",
    weight: 11, length: 100, width: 110, height: 100, point_of_departure: 'Нижний Новгород',
    destination: 'Москва', distance: nil, price: nil, user_id: users[0].id}
